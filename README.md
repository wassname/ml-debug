...
- **[SKILL.md](SKILL.md)** -- what an agent loads. Not the folklore, which agents read and ignore. Instead the rituals the folklore implies: a trigger, a form to fill, and an artifact to show the user. "Assume you have a bug" becomes "send a subagent to find one and report what it found".
