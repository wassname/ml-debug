...
**Source:** https://github.com/karpathy/nanochat/blob/master/dev/LOG.md (primary experiment log, verbatim)
**Fetched-via:** curl of raw.githubusercontent.com master branch, 2026-08-15 (CLAUDE agent)
**Fetch-status:** full log. Replaces a 1179-word synthesis of deepwiki sections 3/12/13, accessed 2026-03; deepwiki pages are AI-generated from source, this log is the primary record and now runs to 2026-05.
**Context:** nanochat is Karpathy's 2026 open-source minimal LLM speedrun (GPT-2 level in ~2.5h on 8xH100, ~3500 lines).
