Source: https://github.com/google-research/tuning_playbook (README.md, main branch)
...
Fetched-via: curl -sL https://raw.githubusercontent.com/google-research/tuning_playbook/main/README.md, 2026-08-15 (CLAUDE agent)
Fetch-status: verbatim, full README; the whole playbook lives in this single file. Replaces the earlier hand-picked excerpts (CLAUDE agent)
